...
# def ingest_docs():
#     # loader = ReadTheDocsLoader("website-doc/vkaps.com")
#     # loader = ReadTheDocsLoader("website-doc/vkaps.com/index.html")
...
#         new_url = new_url.replace("https://", "")  # Remove "https://" if present
